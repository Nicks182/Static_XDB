...
namespace Static_XDB.HTML
{
    ...
    {
        private HTML_Object _Tracking_SubHeader()
        {
            ...
            L_HTML_Object.Add_Child(_Tracking_SubHeader_ObjectChanges_Btn());
            

            return L_HTML_Object;
        }

        private HTML_Object _Tracking_SubHeader_ObjectChanges_Btn()
        {
            HTML_Object L_HTML_Object = G_SH_Components._Button(new SH_Components_Info
            {
                Caption = "Check For Object Changes"
            });
            ...
            {
                Message_Type = Services.TM_Message_Type.Tracking_Check_Objects,
            }));
